...
export {}
declare global {
  const AIM: typeof import('./components/apps/AIM')['default']
  const AIMChat: typeof import('./components/apps/AIMChat')['default']
  ...
  const Bear: typeof import('./components/apps/Notes')['default']
  const ControlCenterMenu: typeof import('./components/menus/ControlCenterMenu')['default']
  const DesktopFolder: typeof import('./components/apps/DesktopFolder')['default']
  ...
  const MobileAppWindow: typeof import('./components/MobileAppWindow')['default']
  ...
  const Trash: typeof import('./components/apps/Trash')['default']
  ...
  const useAIMSounds: typeof import('./hooks/useAIMSounds')['default']
