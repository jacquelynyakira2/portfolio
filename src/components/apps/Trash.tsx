  ...
  return (
    <div className="relative w-full h-full flex flex-col bg-c-50">
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        {/* Sidebar */}
        <div className="hidden w-48 bg-c-100/50 border-r border-c-300 overflow-y-auto py-2 sm:block">
        ...
        >
          <div className="grid grid-cols-3 gap-6 sm:flex sm:flex-wrap sm:gap-10">
            {/* The lost ideas folder */}
            <div
              className="flex min-w-0 flex-col items-center cursor-pointer group"
            ...
            >
              ...
              <div className="mt-1 max-w-full text-center text-xs text-c-800">
                lost ideas
              </div>
              <div className="mt-0.5 hidden text-[11px] text-c-500 opacity-0 transition-opacity group-hover:opacity-100 sm:block">
                {folderHint}
              </div>
            </div>
            ...
            {TRASH_ITEMS.map((item) => (
              <div
                key={item.id}
                className="flex min-w-0 flex-col items-center text-center group sm:w-24"
                onClick={(event) => {
              ...
              >
                ...
                <div
                  className={`mt-1 max-w-full truncate text-xs leading-tight px-1 py-0.5 rounded transition-colors ${
          ...
          {isUnlocked && isIdeaShelfOpen && (
            <div className="mt-10 border-t border-c-200 pt-6">
              ...
              <div className="mt-4 grid grid-cols-3 gap-6 sm:flex sm:flex-wrap sm:gap-8">
                {IDEA_FILES.map((idea) => (
                  <button
                    key={idea.id}
                    type="button"
                    className="flex min-w-0 flex-col items-center text-center group focus:outline-none sm:w-24"
                  ...
                  >
                    ...
                    <div className="mt-1 max-w-full truncate text-xs text-c-700 leading-tight">
                      {idea.name}
                    </div>
      ...
      {isPromptOpen && (
        <div className="absolute inset-0 bg-c-900/50 backdrop-blur-sm flex items-center justify-center p-4 sm:p-6">
          <div className="bg-white/95 rounded-2xl shadow-2xl w-full max-w-xs p-5 sm:p-6 space-y-4">
            <div>
      ...
      {activeTextItem && (
        <div
          className="absolute inset-0 bg-c-900/40 backdrop-blur flex items-center justify-center p-4 sm:p-6"
          onClick={() => setActiveTextItem(null)}
        >
          <div
            className="max-h-full w-full max-w-sm overflow-y-auto rounded-2xl bg-white/95 p-5 shadow-2xl sm:p-6"
      ...
      {activeIdea && (
        ...
        >
          <div
            className="max-h-full w-full max-w-lg overflow-y-auto rounded-2xl bg-white/95 p-5 shadow-2xl sm:p-6"
            onClick={(event) => event.stopPropagation()}
          >
            <div className="flex items-start justify-between gap-4">
              <div>
